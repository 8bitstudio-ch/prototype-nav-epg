<template>
  <div class="dropdown" @mouseover="openSubmenu" @mouseleave="closeSubmenu">
    <MainNavItem>S'engager</MainNavItem>
    ...
    <div v-show="isOpen" class="dropdown__submenu">
      <Tabs>
          ...
          <ul class="nav-tabs">
            ...
            <li>
              <a href="#" @mouseover="this.emitter.emit('closeTabPanels')">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16" style="margin-right: .3em">
        ...
        <template v-slot:tabContent>
          <TabPanel title="formations">
            <ul>
              <li><a href="#">Jeune Accompagnant de KT</a></li>
              <li><a href="#">Conseiller / Délégué de paroisse</a></li>
              <li><a href="#">Prédicateur</a></li>
            </ul>
          </TabPanel>

          <TabPanel title="enfants-jeunes">
            <ul>
              <li><a href="#">Cathéchisme (KT) à partir de 4ans</a></li>
